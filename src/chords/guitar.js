// Guitar chord database (EADGBE, strings 0-5 = low E to high e)
// frets: -1=muted, 0=open, N=fret number
export const guitarChords = new Map([
  ['C',    [{ frets: [-1,3,2,0,1,0], fingers:[0,3,2,0,1,0], barre:null, baseFret:1 }]],
  ['Cm',   [{ frets: [-1,3,5,5,4,3], fingers:[0,1,3,4,2,1], barre:{fret:3,from:0,to:5}, baseFret:3 }]],
  ...
  ['Cm7',  [{ frets: [-1,3,5,3,4,3], fingers:[0,1,3,1,2,1], barre:{fret:3,from:0,to:5}, baseFret:3 }]],
  ['Csus2',[{ frets: [-1,3,0,0,1,3], fingers:[0,2,0,0,1,4], barre:null, baseFret:1 }]],
  ['Csus4',[{ frets: [-1,3,3,0,1,1], fingers:[0,3,4,0,1,1], barre:null, baseFret:1 }]],
  ['Cdim', [{ frets: [-1,-1,1,2,1,2], fingers:[0,0,1,3,2,4], barre:null, baseFret:1 }]],
  ['Caug', [{ frets: [-1,3,2,1,1,0], fingers:[0,4,3,1,2,0], barre:null, baseFret:1 }]],

  ['C#',   [{ frets: [-1,4,3,1,2,1], fingers:[0,4,3,1,2,1], barre:{fret:1,from:2,to:5}, baseFret:1 }]],
  ['C#m',  [{ frets: [-1,4,6,6,5,4], fingers:[0,1,3,4,2,1], barre:{fret:4,from:0,to:5}, baseFret:4 }]],
  ['C#7',  [{ frets: [-1,4,3,4,2,1], fingers:[0,4,3,4,2,1], barre:null, baseFret:1 }]],
  ['C#maj7',[{ frets:[-1,4,3,1,1,1], fingers:[0,4,3,1,1,1], barre:{fret:1,from:2,to:5}, baseFret:1 }]],

  ['Db',   [{ frets: [-1,4,3,1,2,1], fingers:[0,4,3,1,2,1], barre:{fret:1,from:2,to:5}, baseFret:1 }]],
  ['Dbm',  [{ frets: [-1,4,6,6,5,4], fingers:[0,1,3,4,2,1], barre:{fret:4,from:0,to:5}, baseFret:4 }]],
  ...
  ['Dm7',  [{ frets: [-1,-1,0,2,1,1], fingers:[0,0,0,2,1,1], barre:null, baseFret:1 }]],
  ['Dsus2',[{ frets: [-1,-1,0,2,3,0], fingers:[0,0,0,1,3,0], barre:null, baseFret:1 }]],
  ['Dsus4',[{ frets: [-1,-1,0,2,3,3], fingers:[0,0,0,1,3,4], barre:null, baseFret:1 }]],
  ['Ddim', [{ frets: [-1,-1,0,1,0,1], fingers:[0,0,0,1,0,2], barre:null, baseFret:1 }]],
  ['Daug', [{ frets: [-1,-1,0,3,3,2], fingers:[0,0,0,3,4,2], barre:null, baseFret:1 }]],
  ...
  ['Emaj7',[{ frets: [0,2,1,1,0,0], fingers:[0,3,2,1,0,0], barre:null, baseFret:1 }]],
  ...
  ['Eaug', [{ frets: [0,3,2,1,1,0], fingers:[0,4,3,1,2,0], barre:null, baseFret:1 }]],
  ...
  ['Fmaj7',[{ frets: [1,3,3,2,1,0], fingers:[1,3,4,2,1,0], barre:{fret:1,from:0,to:4}, baseFret:1 }]],
  ['Fm7',  [{ frets: [1,3,1,1,1,1], fingers:[1,3,1,1,1,1], barre:{fret:1,from:0,to:5}, baseFret:1 }]],
  ['Fsus2',[{ frets: [1,1,3,3,1,1], fingers:[1,1,3,4,1,1], barre:{fret:1,from:0,to:5}, baseFret:1 }]],
  ['Fdim', [{ frets: [-1,-1,0,1,0,1], fingers:[0,0,0,1,0,2], barre:null, baseFret:1 }]],
  ...
  ['Gb',   [{ frets: [2,4,4,3,2,2], fingers:[1,3,4,2,1,1], barre:{fret:2,from:0,to:5}, baseFret:2 }]],
  ['Gbm',  [{ frets: [2,4,4,2,2,2], fingers:[1,3,4,1,1,1], barre:{fret:2,from:0,to:5}, baseFret:2 }]],
  ...
  ['Gsus4',[{ frets: [3,3,0,0,1,3], fingers:[3,4,0,0,1,3], barre:null, baseFret:1 }]],
  ['Gdim', [{ frets: [-1,-1,5,6,5,6], fingers:[0,0,1,3,2,4], barre:null, baseFret:5 }]],
  ['Gaug', [{ frets: [-1,-1,5,4,4,3], fingers:[0,0,4,2,3,1], barre:null, baseFret:3 }]],
  ...
  ['Ab',   [{ frets: [4,6,6,5,4,4], fingers:[1,3,4,2,1,1], barre:{fret:4,from:0,to:5}, baseFret:4 }]],
  ['Abm',  [{ frets: [4,6,6,4,4,4], fingers:[1,3,4,1,1,1], barre:{fret:4,from:0,to:5}, baseFret:4 }]],
  ...
  ['Asus4',[{ frets: [-1,0,2,2,3,0], fingers:[0,0,1,2,4,0], barre:null, baseFret:1 }]],
  ...
  ['A#',   [{ frets: [-1,1,3,3,3,1], fingers:[1,1,2,3,4,1], barre:{fret:1,from:0,to:5}, baseFret:1 }]],
  ['A#m',  [{ frets: [-1,1,3,3,2,1], fingers:[1,1,3,4,2,1], barre:{fret:1,from:0,to:5}, baseFret:1 }]],
  ['Bb',   [{ frets: [-1,1,3,3,3,1], fingers:[1,1,2,3,4,1], barre:{fret:1,from:0,to:5}, baseFret:1 }]],
  ['Bbm',  [{ frets: [-1,1,3,3,2,1], fingers:[1,1,3,4,2,1], barre:{fret:1,from:0,to:5}, baseFret:1 }]],
  ['Bb7',  [{ frets: [-1,1,3,1,3,1], fingers:[1,1,3,1,4,1], barre:{fret:1,from:0,to:5}, baseFret:1 }]],

  ['B',    [{ frets: [-1,2,4,4,4,2], fingers:[1,1,2,3,4,1], barre:{fret:2,from:0,to:5}, baseFret:2 }]],
  ['Bm',   [{ frets: [-1,2,4,4,3,2], fingers:[1,1,3,4,2,1], barre:{fret:2,from:0,to:5}, baseFret:2 }]],
  ['B7',   [{ frets: [-1,2,1,2,0,2], fingers:[0,2,1,3,0,4], barre:null, baseFret:1 }]],
  ['Bmaj7',[{ frets: [-1,2,4,3,4,2], fingers:[1,1,3,2,4,1], barre:{fret:2,from:0,to:5}, baseFret:2 }]],
  ['Bm7',  [{ frets: [-1,2,4,2,3,2], fingers:[1,1,3,1,2,1], barre:{fret:2,from:0,to:5}, baseFret:2 }]],
  ['Bsus4',[{ frets: [-1,2,4,4,5,2], fingers:[1,1,2,3,4,1], barre:{fret:2,from:0,to:5}, baseFret:2 }]],
]);
